...
@section('content')
    <div class="container mt-5">
        ...
        {{-- Form Pencarian --}}
        {{-- <form method="GET" action="{{ route('admin.list') }}" class="d-flex justify-content-center mb-3">
            <input type="text" name="search" class="form-control w-50 me-2" placeholder="Cari username atau nama apotek..."
                value="{{ $search }}">
